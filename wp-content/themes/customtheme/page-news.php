    ...
    <div class="inner">
        <div id="tabs">
            <ul class="tab-list">
                ...
                <li><a href="#tab-2"><span>New01</span></a></li>
                <li><a href="#tab-3"><span>New02</span></a></li>
                <li><a href="#tab-4"><span>New03</span></a></li>
            </ul>
            <div id="tab-1">
            ...
            <div id="tab-2">
            <?php query_posts('category_name=new01&showposts=1&paged='.$paged);
            if( have_posts() ): while( have_posts() ): the_post(); ?>
                <div class="custom-list">
                    <div class="list-gp">
                        <figure>
            ...
            <div id="tab-4">
            <?php query_posts('category_name=new03&showposts=1&paged='.$paged);
            if( have_posts() ): while( have_posts() ): the_post(); ?>
                <div class="custom-list">
                    <div class="list-gp">
                        <figure>
